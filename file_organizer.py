...
count={"Images":0,"Documents":0,"Videos":0,"Audio":0,"Python":0,"Java":0,"Archives":0,"Others":0}
file_path=input()
...
print("Audio    : ",count["Audio"])
print("Python   : ",count["Python"])
print("Java     : ",count["Java"])
print("Archives : ",count["Archives"])
